...
For my shader I used existing one from https://www.shadertoy.com/view/4tdSWr and modified it to fit my needs. I added a slider to control the cloud cover and other values.
